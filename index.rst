...
`Cangjie`_ and `Quick`_ input methods.

We believe in the value of sharing our work with the rest of the world, which
is why IBus Cangjie is Free Software, under the `GNU LGPLv3+ license`_.
...
IBus Cangjie is providing :doc:`a great user experience <discover>` already,
